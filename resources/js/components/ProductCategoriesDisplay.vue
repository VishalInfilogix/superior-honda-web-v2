<template>
  <div>
    ...
    <div class="ra_services_provide_wraper" id="services">
      ...
      <div class="ra_para_style">Choose from a wide assortment of car services from periodic car
          servicing, car care services, wheel care services, cashless
          insurance claims and much more!
      </div>
      <div class="ra_services_grid">
        <a v-for="product_category in filteredProducts" :key="product_category.id" :href="'/product-category/' + product_category.product_category_slug">
          <div class="ra_services_grid_data">
            <div class="ra_services_flex">
              <img
                loading="lazy"
                :src="this.main_web_url + product_category.category_image"
